...
Let,\hfill \\
\centering{$\boldsymbol{A}$-$\boldsymbol{B}$=$\boldsymbol{p1}$\hfill\\
           $\boldsymbol{D}$-$\boldsymbol{C}$=$\boldsymbol{s1}$\hfill\\
           $\boldsymbol{A}$-$\boldsymbol{D}$=$\boldsymbol{p2}$\hfill\\
           $\boldsymbol{B}$-$\boldsymbol{C}$=$\boldsymbol{s2}$\hfill}\\
\justify
\vspace{0.1cm}
